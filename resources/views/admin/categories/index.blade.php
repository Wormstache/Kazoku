                        ...
                        <table id="table_id" class="table table-borderless table-data3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-info" data-toggle="modal" data-target="#categoryEdit{{ $category->id }}" href="{{ route('adminCategory.edit',$category->id) }}"><i class="zmdi zmdi-edit"></i></button></td>
                                    <td>
    ...
    <div class="modal fade" id="categoryEdit{{ $category->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form name="category" action="{{ route('adminCategory.update', $category->id) }}" method="post" enctype="multipart/form-data">
